...
if (isset($_POST["btn-add-installment"])) {
    ...
    if ($confirmation_delete != $debt_id) {
        ...
        header("Location: ../installmentDebt.php?debt_id=$debt_id&errorMessage=" . urlencode($response));
    } else {
        ...
        $accumulation_total_debt = strval($purchase_total - $total_installment);
        ...
        header("Location: ../installmentDebt.php?debt_id=$debt_id&successMessage=" . urlencode($response));
    }
}
