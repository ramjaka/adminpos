        ...
        <div class="content container-fluid">
                    ...
                    <div class="col-sm mb-2 mb-sm-0">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-no-gutter">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Ledger Assets</li>
                            </ol>
                        </nav>

                        <h1 class="page-header-title">Ledger Assets</h1>
                    </div>
                    <!-- End Col -->
                </div>
                <!-- End Row -->
                            ...
                            ?>
                                <div class="col mb-3 mb-lg-5">
                                    ...
                                    <div class="card card-sm card-hover-shadow card-header-borderless h-100 text-center">
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title text-uppercase"><?php echo $row['bank_account_name'] ?></h5>
                                            <p class="small"><?php echo "Rp " . number_format($row['last_balance'], 0, ',', '.'); ?></p>
                                        </div>

                                        <a class="stretched-link" href="ledgerAssetsDetails.php?bank_account_number=<?php echo $row['bank_account_number'] ?>"></a>
                                    </div>
                                    <!-- End Card -->
                                </div>
                            <?php } ?>
                            ...
                            ?>
                                <div class="col mb-3 mb-lg-5">
                                    ...
                                    <div class="card card-sm card-hover-shadow card-header-borderless h-100 text-center">
                                        ...
                                        <a class="stretched-link" href="ledgerAssetsDetails.php?product_sku=<?php echo $row['product_sku'] ?>"></a>
                                    </div>
                                    <!-- End Card -->
                                </div>
                            <?php } ?>
            ...
            <div class="tab-content" id="connectionsTabContent">
                <div class="tab-pane fade show active" id="grid" role="tabpanel" aria-labelledby="grid-tab">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4">
                        <?php
                        $sql = "SELECT * FROM `spending` WHERE `spending_description` LIKE '%Office Needs%' OR `spending_description` LIKE '%Repaid Rent%'";
                            ...
                            ?>
                                <div class="col mb-3 mb-lg-5">
                                    ...
                                    <div class="card card-sm card-hover-shadow card-header-borderless h-100 text-center">
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title text-uppercase"><?php echo $row['spending_name'] ?></h5>
                                            <!-- <p class="small"><?php echo "Rp " . number_format($row['last_balance'], 0, ',', '.'); ?></p> -->
                                        </div>

                                        <a class="stretched-link" href="ledgerAssetsDetails.php?spending_description=<?php echo $row['spending_description'] ?>"></a>
                                    </div>
                                    <!-- End Card -->
                                </div>
                            <?php } ?>
