...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
    ...
    <main id="content" role="main" class="main">
        ...
        <div class="content container-fluid">
                    ...
                    <div class="col-sm mb-2 mb-sm-0">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-no-gutter">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Ledger Expense</li>
                            </ol>
                        </nav>

                        <h1 class="page-header-title">Ledger Expense</h1>
                    </div>
                    <!-- End Col -->
                </div>
                <!-- End Row -->
                <a href="bankAccounting.php" class="btn btn-white"><i class="bi bi-chevron-left"></i> back</a>
            </div>
            <!-- End Page Header -->
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4">
                        <div class="col mb-3 mb-lg-5">
                            ...
                            <div class="card card-sm card-hover-shadow card-header-borderless h-100 text-center">
                                ...
                                <div class="card-body">
                                    <i class="bi bi-journal-bookmark-fill display-2"></i>
                                </div>

                                <div class="card-body">
                                    <h5 class="card-title text-uppercase">Utility Expense</h5>
                                </div>

                                <a class="stretched-link" href="ledgerExpenseDetails.php?spending_description=Utility%20Expense"></a>
                            </div>
                            <!-- End Card -->
                        </div>
                        <!-- End Col -->
                        ...
                        <div class="col mb-3 mb-lg-5">
                            ...
                            <div class="card card-sm card-hover-shadow card-header-borderless h-100 text-center">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title text-uppercase">Salary Expense</h5>
                                </div>

                                <a class="stretched-link" href="ledgerExpenseDetails.php?spending_description=Salary%20Expense"></a>
                            </div>
                            <!-- End Card -->
                        </div>
                        <!-- End Col -->
                        ...
                        <div class="col mb-3 mb-lg-5">
                            ...
                            <div class="card card-sm card-hover-shadow card-header-borderless h-100 text-center">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title text-uppercase">Other Expense</h5>
                                </div>

                                <a class="stretched-link" href="ledgerExpenseDetails.php?spending_description=Other%20Expense"></a>
                            </div>
                            <!-- End Card -->
                        </div>
                        <!-- End Col -->
            ...
            <h4 class="mb-3">Sales Discount</h4>
            <!-- Tab Content -->
            <div class="tab-content" id="connectionsTabContent">
                <div class="tab-pane fade show active" id="grid" role="tabpanel" aria-labelledby="grid-tab">
                    <!-- Folders -->
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4">
                        ...
                        <div class="col mb-3 mb-lg-5">
                            ...
                            <div class="card card-sm card-hover-shadow card-header-borderless h-100 text-center">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title text-uppercase">Sales discount</h5>
                                </div>

                                <a class="stretched-link" href="ledgerExpenseDetails.php?sales_discount=Sales%20Discount"></a>
                            </div>
                            <!-- End Card -->
                        </div>
                        <!-- End Col -->
                            ...
                            ?>
                                <div class="col mb-3 mb-lg-5">
                                    ...
                                    <div class="card card-sm card-hover-shadow card-header-borderless h-100 text-center">
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title text-uppercase"><?php echo $row['product_name'] ?></h5>
                                        </div>

                                        <a class="stretched-link" href="ledgerExpenseDetails.php?product_sku=<?php echo $row['product_sku'] ?>"></a>
                                    </div>
                                    <!-- End Card -->
                                </div>
                                <!-- End Col -->
