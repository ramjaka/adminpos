            ...
            <div class="page-header">
                <div class="row align-items-end">
                    <div class="col-sm mb-2 mb-sm-0">
                        ...
                        <h1 class="page-header-title">CRM</h1>
                    </div>
                    <!-- End Col -->

                    <div class="col-sm-auto">
                        <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addMemberModal"><i class="bi bi-person-plus"></i> Create Member</a>
                    </div>
                </div>
                <!-- End Row -->
            </div>
                    ...
                    <div class="mb-2 mb-md-0">
                        <form>
                            ...
                            <div class="input-group input-group-merge input-group-flush">
                                ...
                                <input id="datatableSearch" type="search" class="form-control" placeholder="Search member" aria-label="Search users">
                            </div>
                            <!-- End Search -->
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="addMemberModalTitle">Create member</h5>
                ...
                <div class="table-responsive datatable-custom">
                    ...
                    "pagination": "datatablePagination"
                        ...
                        <thead class="thead-light">
                            <tr>
                                <th class="table-column-pe-0">Member Name</th>
                                <th>Phone Number</th>
                                <th>Email</th>
                                <th>Address</th>
                                <th>Status</th>
                                ...
                                ?>
                                    <tr>
                                        <td class="table-column-pe-0">
                                            <a href="customerProfile.php?member_id=<?php echo $row['member_id']; ?>" class="text-muted">
                                                <div class="avatar avatar-soft-primary avatar-circle me-2">
                                                    <span class="avatar-initials"><?php echo substr($row['member_first_name'], 0, 1) ?></span>
                                                </div>
                                        ...
                                        <td>
                                            <input name="member_phone" type="text" class="js-input-mask border-0" id="phoneLabel" placeholder="+(xx) xxx-xxx-xxx-xxx" data-hs-mask-options='{
                                            "mask": "+(00) 000-000-000-000"
                                            }' value="<?php echo $row['member_phone'] ?>" readonly>
                                        </td>
                                        <td>
