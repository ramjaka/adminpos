...
if (isset($_GET['transaction_description']) && !empty($_GET['transaction_description'])) {
    $transaction_description = $_GET['transaction_description'];

    // sales transaction description
    $query = "SELECT * FROM `mutation` WHERE transaction_description = '$transaction_description'";
    ...
    <main id="content" role="main" class="main">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-no-gutter">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    Ledger - <?php echo $transaction_description ?>
                                </li>
                            </ol>
                        </nav>
                ...
                <!-- End Row -->
                <a href="ledgerEquity.php" class="btn btn-white"><i class="bi bi-chevron-left"></i> back</a>
            </div>
            <!-- End Page Header -->
            ...
            <div class="table-responsive datatable-custom">
                <table id="datatable" class="table table-lg table-bordered table-thead-bordered table-nowrap table-align-middle card-table table-striped table-hover" data-hs-datatables-options='{
                    ...
                    <?php if ($transaction_description === 'Equity') { ?>
                        <tbody>
                            <?php
                            $sql = "SELECT 
                                        *
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    // Hitung total debt dan credit
                                    $totalDebt += (!empty($row['debt'])) ? floatval($row['debt']) : 0;
                                    $totalCredit += (!empty($row['credit'])) ? floatval($row['credit']) : 0;
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td <?php echo ($rowCount == $totalRows) ? 'class="fw-bold border-bottom"' : ''; ?>>
                                            <?php echo ($rowCount == $totalRows) ? '<u>' . "Rp " . number_format(floatval($balance), 0, ',', '.') . '</u>' : "Rp " . number_format(floatval($balance), 0, ',', '.'); ?>
                                        </td>
                                    </tr>
                            <?php
                                }
                    ...
                    <?php if ($transaction_description === 'Prive') { ?>
                        <tbody>
                            <?php
                            $sql = "SELECT 
                                        *
