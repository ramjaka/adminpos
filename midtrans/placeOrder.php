...
if (isset($_POST["btn-add-sales"])) {
    ...
    // VALUES ('$transaction_id', '$receivable_id', '$bank_account_number', '$member_id', '$bank_account_name', '$member_name', '$promotion_name', '$promotion_value', '$sales_date', '$maturity', '$amount', '$total', 'active', '$payment_method', '', '$username_creator', '', NOW())";
    ...
    foreach ($sales_details as $detail) {
        ...
        // VALUES ('$transaction_id', '$product_sku', '$product_name', '$product_qty', '$item_amount_purchase', '$selling_price', '$COGS', '$item_amount', 'active', '$sales_date', '$username_creator', NOW())";
    ...
    // VALUES ('$transaction_id', '$receivable_id', '$bank_account_number', '$bank_account_name', '$total', '$last_balance', 'Sales with invoice #$transaction_id', '', '$username_creator', '', NOW())";
...
\Midtrans\Config::$serverKey = 'SB-Mid-server-2tycrW3SSVJ0j38xaklbVDSM';
...
header("Location: ../posCashier.php?snap_token=$snapToken");