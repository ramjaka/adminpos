...
if (isset($_GET['spending_description']) && !empty($_GET['spending_description'])) {
    ...
    // sales transaction description
    $query = "SELECT * FROM `spending` WHERE spending_description = '$spending_description'";
...
// sales discount
if (isset($_GET['sales_discount']) && !empty($_GET['sales_discount'])) {
    $sales_discount = $_GET['sales_discount'];
}
    ...
    <main id="content" role="main" class="main">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                            ...
                            <ol class="breadcrumb breadcrumb-no-gutter">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    ...
                                    <?php if (isset($spending_description)) { ?>
                                        <?php echo $spending_description ?>
                                    <?php } ?>
                                    <?php if (isset($product_sku)) { ?>
                                        <?php echo $product_sku ?>
                                    <?php } ?>
                                    <?php if (isset($sales_discount)) { ?>
                                        Sales Discount
                                    <?php } ?>
                                </li>
                            </ol>
                ...
                <!-- End Row -->
                <a href="ledgerExpense.php" class="btn btn-white"><i class="bi bi-chevron-left"></i> back</a>
            </div>
            <!-- End Page Header -->
                ...
                <table id="datatable" class="table table-lg table-bordered table-thead-bordered table-nowrap table-align-middle card-table table-striped table-hover" data-hs-datatables-options='{
                    ...
                    <?php if (isset($sales_discount)) { ?>
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td class="table-column-pe-0"><?php echo date('d-m-Y', strtotime($row['sales_date'])); ?></td>
                                    <td><?php echo $row['sales_transaction_id'] ?></td>
                                    <td><?php echo "Rp " . number_format(floatval($row['sales_discount']), 0, ',', '.'); ?></td>
                                    <td>-</td>
                                    <td <?php echo ($rowCount == $totalRows) ? 'class="fw-bold border-bottom"' : ''; ?>>
                                        <?php echo ($rowCount == $totalRows) ? '<u>' . "Rp " . number_format($totalDiscount, 0, ',', '.') . '</u>' : "Rp " . number_format(floatval($row['sales_discount']), 0, ',', '.'); ?>
                                    </td>
                                </tr>
                            <?php
                            }
