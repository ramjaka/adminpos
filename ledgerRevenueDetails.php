    ...
    <main id="content" role="main" class="main">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                ...
                <!-- End Row -->
                <a href="ledgerRevenue.php" class="btn btn-white"><i class="bi bi-chevron-left"></i> back</a>
            </div>
            <!-- End Page Header -->
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                $totalDebt += (!empty($row['sales_subtotal'])) ? floatval($row['sales_subtotal']) : 0;
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo (!empty($row['sales_subtotal'])) ? "Rp " . number_format(floatval($row['sales_subtotal']), 0, ',', '.') : '-'; ?></td>
