...
$sql = "SELECT COUNT(*) AS total_rows FROM purchase WHERE YEAR(purchase_created_at) = YEAR(NOW()) AND purchase_status = 'active'";

$result = $mysqli->query($sql);

if ($result->num_rows > 0) {
    $row = $result->fetch_assoc();
    $purchase_counter = $row["total_rows"];
}
            ...
            <div class="page-header">
                <div class="row align-items-end">
                    <div class="col-sm mb-2 mb-sm-0">
                        ...
                        <h1 class="page-header-title">Purchasing List <span class="badge bg-soft-dark text-dark ms-2"><?php echo $purchase_counter ?></span></h1>
                    </div>
                    <!-- End Col -->
                </div>
                <!-- End Row -->
                    ...
                    <table id="datatable" class="table table-lg table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
                        ...
                        ";
                            ...
                            if ($date_from && $date_select) {
                                $sql .= " WHERE DATE(p.purchase_date) BETWEEN '$date_from' AND '$date_select'";
                            }
