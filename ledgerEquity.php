                    ...
                    <div class="col-sm mb-2 mb-sm-0">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-no-gutter">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Ledger Equity</li>
                            </ol>
                        </nav>

                        <h1 class="page-header-title">Ledger Equity</h1>
                    </div>
                    <!-- End Col -->
                </div>
                <!-- End Row -->
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4">
                        <div class="col mb-3 mb-lg-5">
                            ...
                            <div class="card card-sm card-hover-shadow card-header-borderless h-100 text-center">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title text-uppercase">Equity</h5>
                                </div>

                                <a class="stretched-link" href="ledgerEquityDetails.php?transaction_description=Equity"></a>
                            </div>
                            <!-- End Card -->
                        </div>
                        <!-- End Col -->
                        ...
                        <div class="col mb-3 mb-lg-5">
                            ...
                            <div class="card card-sm card-hover-shadow card-header-borderless h-100 text-center">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title text-uppercase">Prive</h5>
                                </div>

                                <a class="stretched-link" href="ledgerEquityDetails.php?transaction_description=Prive"></a>
                            </div>
                            <!-- End Card -->
                        </div>
                        <!-- End Col -->
