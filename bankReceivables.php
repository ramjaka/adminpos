...
$page = 'bank-receivables';
$page_access = array('1', '14');
...
$query = "SELECT b.bank_account_number, b.bank_account_name, b.bank_account_holder, b.bank_account_status, b.bank_account_type, (SELECT m.last_balance FROM `mutation` m WHERE m.bank_account_number = '123receivables' ORDER BY m.mutation_created_at DESC LIMIT 1) AS last_balance FROM `bank_account` b ORDER BY bank_account_created_at";
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col-sm mb-2 mb-sm-0">
                        ...
                        <h1 class="page-header-title">Receivables</h1>
                    </div>
                    <!-- End Col -->
                </div>
                <!-- End Row -->
            ...
            <div class="col-sm-12 mb-4 p-0">
                ...
                <div class="card card-centered bg-light h-100 rounded-3 shadow-none">
                    <div class="card-body text-center">
                        <div class="mb-3">
                            <img class="avatar avatar-xl avatar-4x3" src="assets/svg/illustrations/oc-referrals.svg" alt="Image Description" data-hs-theme-appearance="default">
                            <img class="avatar avatar-xl avatar-4x3" src="assets/svg/illustrations-light/oc-referrals.svg" alt="Image Description" data-hs-theme-appearance="dark">
                        </div>

                        <span class="display-4 d-block text-dark"> <?php echo "Rp " . number_format($row['last_balance'], 0, ',', '.'); ?></span>

                        <span class="d-block">
                            &mdash; Total receivables
                        </span>
                    </div>
                </div>
                <!-- End Body -->
                ...
                <div class="table-responsive datatable-custom">
                    <table id="datatable" class="table table-lg table-borderless table-thead-bordered table-nowrap table-align-middle card-table table-striped table-hover" data-hs-datatables-options='{
                        ...
                        <tbody>
                            ...
                            INNER JOIN `receivable` r ON m.receivable_id = r.receivable_id
                            WHERE b.bank_account_number = '123receivables'
                            AND r.status = 'active'";

                            if ($date_from && $date_select) {
                                $sql .= " AND r.receivable_status = '1' 
                                AND DATE(r.receivable_due_date) BETWEEN '$date_from' AND '$date_select'";
                            }
                            ...
                            if ($result->num_rows > 0) { ?>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="installmentReceivable.php?receivable_id=<?php echo $row['receivable_id']; ?>">
                                                #<?php echo $row['receivable_id'] ?>
                                            </a>
                                        </td>
                                        <td>
                                            <?php echo $row['receivable_due_date'] ?><br>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="badge bg-soft-success text-success <?php echo ($row['receivable_status'] === '2') ? '' : 'd-none'; ?>">
                                        ...
                                        <td>
                                            <?php echo "Rp " . number_format(floatval($row['receivable_total']), 0, ',', '.'); ?>
                                        </td>
                                        <td>
